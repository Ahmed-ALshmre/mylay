...
class Wark extends StatefulWidget {
  @override
  _WarkState createState() => _WarkState();
}

class _WarkState extends State<Wark> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => Wark())).then((value) {
      setState(() {});
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("${AppLocale.of(context).getTranslated('Emplois')}",),
      ),
