...
import 'auto.dart';
class FalterVelos extends StatefulWidget {
  @override
  _FalterVelosState createState() => _FalterVelosState();
}

class _FalterVelosState extends State<FalterVelos> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => FalterVelos()))
        .then((value) {
      setState(() {});
    });
  }
