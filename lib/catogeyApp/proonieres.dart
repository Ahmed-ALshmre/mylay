...
class Poro extends StatefulWidget {
  final bool isPostef;
  final bool isHome;
  const Poro({Key key, this.isPostef, this.isHome}) : super(key: key);
  @override
  _PoroState createState() => _PoroState();
}

class _PoroState extends State<Poro> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => Poro()))
        .then((value) {
      setState(() {});
    });
  }
                          ...
                          children: [
                            ...
                            widget.isPostef
                              ...
                              onTap: () async {
                                ...
                                if (list != null) {
                                  print("ssssssss$selectedUserList");
                                  setState(() {
  ...
  Widget _drawProducts() {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance
          .collection('Auto')
          .orderBy('bool', descending: true).where("catoCar")
          .snapshots(),
