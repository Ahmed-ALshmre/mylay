...
class FalterMobiles extends StatefulWidget {
  @override
  _FalterMobilesState createState() => _FalterMobilesState();
}

class _FalterMobilesState extends State<FalterMobiles> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => FalterMobiles()))
        .then((value) {
      setState(() {});
    });
  }
