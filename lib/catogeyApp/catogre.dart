...
class Falter extends StatefulWidget {
  final bool isPostef;
  final bool isHome;
  const Falter({Key key, this.isPostef, this.isHome}) : super(key: key);
  @override
  _FalterState createState() => _FalterState();
}

class _FalterState extends State<Falter> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => Falter()))
        .then((value) {
      setState(() {});
    });
  }
