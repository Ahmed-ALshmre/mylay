...
class FalterElectr extends StatefulWidget {
  @override
  _FalterElectrState createState() => _FalterElectrState();
}

class _FalterElectrState extends State<FalterElectr> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => FalterElectr()))
        .then((value) {
      setState(() {});
    });
  }
