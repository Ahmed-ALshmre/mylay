...
class FalterEmpiois extends StatefulWidget {
  ...
  @override
  _FalterEmpioisState createState() => _FalterEmpioisState();
}

class _FalterEmpioisState extends State<FalterEmpiois> {
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => FalterEmpiois()))
        .then((value) {
      setState(() {});
    });
  }
