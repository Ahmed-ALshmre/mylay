...
class _TrickState extends State<Trick> {
  ...
  List<String> contryList = ["luxembourg", "France", "Deutschland", "Portugal"];
  int _selectedIndex;
  ...
  Future<Null> _futureRef() async {
    ...
    Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => Trick()))
        .then((value) {
      setState(() {});
    });
  }
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(Icons.search,
                  color: Colors.blueAccent, size: ScreenUtil().setSp(30)),
